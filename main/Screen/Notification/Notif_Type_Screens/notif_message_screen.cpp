#include <format>
#include <string>
#include "notif_message_screen.h"
...
esp_err_t NotifMessageScreen::on_exit()
{
    ESP_LOGI(TAG, "on_exit called");
    return ESP_OK;
}

esp_err_t NotifMessageScreen::draw()
{
...
esp_err_t NotifMessageScreen::show_next_notif()
{
    notif_counter++;
...
esp_err_t NotifMessageScreen::handle_events(uint32_t events)
{
