#include <format>
#include <string>
#include "notif_call_screen.h"
#include "Screen/screen_manager.h"
#include "Common/globals.h"
#include <cstring>

static constexpr const char *TAG = "CALL_NOTIF_SCREEN";

esp_err_t NotifCallScreen::on_enter()
{
...
esp_err_t NotifCallScreen::on_exit()
{
    ESP_LOGI(TAG, "on_exit called");
    return ESP_OK;
}

esp_err_t NotifCallScreen::draw()
{
...
esp_err_t NotifCallScreen::show_next_notif()
{
    notif_counter++;
...
esp_err_t NotifCallScreen::handle_events(uint32_t events)
{
