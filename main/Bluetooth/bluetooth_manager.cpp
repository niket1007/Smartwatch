...
void BluetoothManager::process_complete_line(const char *line)
{
    ...
    ESP_LOGD(TAG, "Gadgetbridge RX: %s", line);
    ...
    void *arg)
{
    ...
    case BLE_GAP_EVENT_CONNECT:
    {
        // ESP_LOGI(
        //     TAG,
        //     "BLE_GAP_EVENT_CONNECT: status=%d, conn_handle=%d",
    ...
    case BLE_GAP_EVENT_DISCONNECT:
        ...
        // ESP_LOGI(
        //     TAG,
        //     "BLE disconnected, reason=%d", event->disconnect.reason);

        connection_handle = BLE_HS_CONN_HANDLE_NONE;

        tx_notifications_enabled = false;
        // TODO: Show on screen if device is connected or failed. Create a new bluetooth connected/disconnected screen
        // Send an gui event BLUETOOTH_DISCONNECTED

        // Advertise again so Gadgetbridge can reconnect
        init_advertising();
    ...
    case BLE_GAP_EVENT_ENC_CHANGE:
        ...
        if (event->enc_change.status == 0)
        {
            ...
            // TODO: Show on screen if device is connected or failed. Create a new bluetooth connected/disconnected screen
            // Send an gui event BLUETOOTH_CONNECTED

            // ESP_LOGI(TAG, "BLE encryption completed");
        }
        else
        {
            // Encryption failed
            ...
            ESP_LOGE(
                TAG, "BLE encryption failed: %d", event->enc_change.status);
        }
    ...
    case BLE_GAP_EVENT_PASSKEY_ACTION:
    {
         ...
         * DISPLAY_ONLY
         *
         * Therefore the phone displays/asks for the
         * passkey and the watch supplies the configured
         * passkey to NimBLE.
         */
            ...
            BLE_SM_IOACT_DISP)
        {
            ...
            {
                xTaskNotify(gui_task_handle, PASSKEY_SCREEN_EVENT, eSetBits);
            }

            // ESP_LOGI(TAG, "BLE passkey: %" PRIu32, pkey.passkey);
...
bool BluetoothManager::ble_is_connected()
{
...
// {
//     char passkey_string[8];

//     snprintf(
//         passkey_string,
//         sizeof(passkey_string),
//         "%06" PRIu32,
//         gv.ble_passkey);

//     /*
//      * 1 means:
//      * connection/pairing started.
//      */
//     if (ts_var.show_passkey_display == 1)
//     {
//         if (gv.active_screen_id !=
//             BLE_PASSKEY_SCREEN)
//         {
//             navigate_to_screen(
//                 BLE_PASSKEY_SCREEN);
...
//     /*
//      * 4 means:
//      * return to the home screen after displaying
//      * the pairing result.
//      */
//     else if (
//         ts_var.show_passkey_display == 4)
...
//     {
//         lv_label_set_text(
//             objects.ble_device_name,
//             "------------------");

//         if (lv_obj_has_state(
//                 objects.ble_user_switch,
//                 LV_STATE_CHECKED))
//         {
//             lv_obj_remove_state(
//                 objects.ble_user_switch,
...
//     /*
//      * The native NimBLE implementation does not keep
//      * Arduino's String/connInfo object.
//      *
//      * If you want to show the peer Bluetooth address,
//      * obtain it with ble_gap_conn_find() and format it
//      * here.
//      */
//     lv_label_set_text(
//         objects.ble_device_name,
